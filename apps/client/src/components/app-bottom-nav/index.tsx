...
const AppBottomNav = memo(() => {
  ...
  return (
    <>
      <nav className="z-40 shrink-0 border-t border-border/70 bg-background/94 px-2 pb-[calc(0.6rem+env(safe-area-inset-bottom))] pt-2 backdrop-blur">
        <div className="mx-auto grid w-full grid-cols-5 gap-1 sm:max-w-lg">
          <Button
            asChild
            variant="ghost"
            className={cn(
